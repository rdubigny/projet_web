...
deux boutons input = submit : un pour acheter, un pour reserver -->	
	<fieldset>
		...
		<h3>Choisissez votre place
			pour ${ sessionScope.representation.nomSpectacle }
		</h3>
		<div id="corps">
			<c:choose>
				<c:when test="${ requestScope.placesRestantes > 0 }">
					...
					pour la séance du <joda:format value="${ sessionScope.representation.date }" pattern="EEEE dd MMMM yyyy 'à' HH 'heures'"/>.</p>
