...
public class PlaceForm {
	...
	/* boolean sp�cifiant s'il s'agit d'une r�servation */
	...
	try {
	    ...
	    resultat = "�chec de l'op�ration : une erreur impr�vue est survenue, merci de r�essayer dans quelques instants.";
	    erreur = e.getMessage();
	    e.printStackTrace();
	}
