...
public class ReservationDaoImpl implements ReservationDao{
    ...
    private static final String SQL_SELECT_RESERVATION = "SELECT rs.id_reservation, "
    		+ "rp.moment_representation, s.nom_spectacle, p.numero_rang, p.numero_siege, z.categorie_prix,s.base_prix"
