...
public class ReservationDaoImpl implements ReservationDao {
	...
	try {
	    ...
	    preparedStatement = initialisationRequetePreparee(connexion,
		    SQL_DELETE_RESERVATION_USER, false, idUtilisateur,
		    idReservation);
    ...
    // il peut supprimer n'importe qu'elle reservation d'un utilisateur
    // quelconque
	...
	reservation.setDate(new DateTime(resultset.getTimestamp(2)));
