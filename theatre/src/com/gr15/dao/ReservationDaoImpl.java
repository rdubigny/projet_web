...
public class ReservationDaoImpl implements ReservationDao {
    ...
    private static final String SQL_SELECT_RESERVATION_USER = "SELECT rs.id_reservation, rp.moment_representation, s.nom_spectacle,"
	    + "p.numero_rang, p.numero_siege, z.categorie_prix,(s.base_prix*z.base_pourcentage_prix)/100 "
	    + "FROM  projweb_db.reservation rs, projweb_db.representation rp, projweb_db.spectacle s, projweb_db.place p, projweb_db.zone z "
	    + "WHERE rs.id_place = p.id_place AND rs.id_representation = rp.id_representation AND rp.id_spectacle = s.id_spectacle "
