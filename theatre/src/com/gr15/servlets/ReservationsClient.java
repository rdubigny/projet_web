...
public class ReservationsClient extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		if (request.getParameter(PARAM_RESERVATION_ID) != null) {
			...
			request.setAttribute(ATT_MESSAGE_ANNULATION, "Votre annulation a réussi !");
			} catch (DAOException e) {
				/*si on recharge la page alors qu'on avait annulé ou qu'une annulation ne marche pas*/
				request.setAttribute(ATT_MESSAGE_ANNULATION, "Votre annulation a échoué ou vous avez rechargé la page !");
			}
		}
	...
	protected void doPost(HttpServletRequest request,
		 ...
		 * seulement les reservations qui ont choisis d'être payer
		 * reservation */
		String[] idReservationString = request.getParameterValues(PARAM_RESERVATION_ID);
