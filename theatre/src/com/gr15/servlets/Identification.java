...
public class Identification extends HttpServlet {
    ...
    public static final String REDIRECTION_ESPACE_RESPONSABLE = "responsable/espaceResponsable";
    ...
    protected void doPost( HttpServletRequest request,
         ...
         * Utilisateur à la session puis redirection vers l'espace client,
         * sinon suppression du bean de la session et redirection vers la page
         * d'identification.
         */
