 ...
 */
@WebServlet("/responsable/annulationReservation")
public class AnnulationReservation extends HttpServlet {
    private static final long serialVersionUID = 1L;
    public static final String VUE = "/responsable/reservationsResponsable";
	...
	if (id != null) {
	    ...
	    try {
		/* récupération de l'identificateur de l'utilisateur connecté */
